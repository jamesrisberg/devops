...
class ImageMagickScreen(Widget):
    ...
    def __init__(self, **kwargs):
        ...
        self._magick_installed = shutil.which("magick") is not None or shutil.which("convert") is not None
    ...
    def compose(self) -> ComposeResult:
        with Horizontal(classes="magick-container"):
            with VerticalScroll(classes="left-panel"):
                ...
                if not self._magick_installed:
                    yield Static("\n⚠ ImageMagick not installed!")
                    yield Button("Install ImageMagick", id="install-magick", variant="warning")
                ...
                with Vertical(id="convert-options", classes="options-group hidden"):
                    ...
                    yield Select(
                        [(("JPEG - small, photos", "jpg")), (("PNG - lossless", "png")),
                         (("WebP - modern, small", "webp")), (("GIF", "gif")),
                         (("TIFF - high quality", "tiff")), (("PDF", "pdf"))],
                        id="output-format", value="jpg"
                    )
                    yield Static("Quality (1-100):")
                    yield Select(
                        [(("High (95)", "95")), (("Good (85)", "85")),
                         (("Medium (75)", "75")), (("Low (60)", "60"))],
                        id="quality", value="85"
                    )
                ...
                with Vertical(id="resize-options", classes="options-group hidden"):
                    ...
                    yield Select(
                        [(("50%", "50%")), (("25%", "25%")),
                         (("1920px wide", "1920x")), (("1280px wide", "1280x")),
                         (("800px wide", "800x")), (("Thumbnail 150px", "150x150")),
                         (("Custom", "custom"))],
                        id="resize", value="50%"
                    )
                    yield Input(placeholder="WxH or W% (e.g., 800x600)", id="resize-custom")
                ...
                with Vertical(id="crop-options", classes="options-group hidden"):
                    ...
                    yield Select(
                        [(("Square (1:1)", "1:1")), (("16:9 widescreen", "16:9")),
                         (("4:3 standard", "4:3")), (("Custom", "custom"))],
                        id="crop", value="1:1"
                    )
                    yield Input(placeholder="WxH+X+Y (e.g., 800x600+100+50)", id="crop-custom")
                
                # Rotate
                yield Checkbox("Rotate / Flip", id="toggle-rotate", classes="toggle-row")
                with Vertical(id="rotate-options", classes="options-group hidden"):
                    yield Static("Rotation:")
                    yield Select(
                        [(("90° clockwise", "90")), (("90° counter-clockwise", "-90")),
                         (("180°", "180")), (("Flip vertical", "flip")),
                         (("Flip horizontal", "flop")), (("Auto-orient", "auto"))],
                        id="rotate", value="90"
                    )
                
                # Adjustments
                yield Checkbox("Adjust colors", id="toggle-adjust", classes="toggle-row")
                with Vertical(id="adjust-options", classes="options-group hidden"):
                    ...
                    yield Input(placeholder="e.g., 120 for more, 80 for less", id="saturation")
                
                # Effects
                yield Checkbox("Apply effects", id="toggle-effects", classes="toggle-row")
                ...
                # Strip metadata
                yield Checkbox("Strip metadata (smaller file)", id="toggle-strip", classes="toggle-row")
